...
Next milestone: a new `.planning/REQUIREMENTS.md` will be created via `/gsd-new-milestone` (file removed after this archive).
...
- [x] **CMD-02**: `/new <name>` — creates and switches to a named OpenCode session
- [x] **CMD-03**: `/switch <name>` — switches active session to the named session
- [x] **CMD-04**: `/sessions` — lists all sessions for the current chat
